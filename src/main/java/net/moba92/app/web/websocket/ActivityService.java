package net.moba92.app.web.websocket;

import net.moba92.app.security.SecurityUtils;
import net.moba92.app.web.websocket.dto.ActivityDTO;
...
import static net.moba92.app.config.WebsocketConfiguration.IP_ADDRESS;
