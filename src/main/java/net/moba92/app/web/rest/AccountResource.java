...
import net.moba92.app.domain.PersistentToken;
import net.moba92.app.domain.User;
import net.moba92.app.repository.PersistentTokenRepository;
import net.moba92.app.repository.UserRepository;
import net.moba92.app.security.SecurityUtils;
import net.moba92.app.service.MailService;
import net.moba92.app.service.UserService;
import net.moba92.app.web.rest.dto.KeyAndPasswordDTO;
