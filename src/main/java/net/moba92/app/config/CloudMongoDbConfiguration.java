package net.moba92.app.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import net.moba92.app.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("net.moba92.app.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("net.moba92.app.config.dbmigrations");
