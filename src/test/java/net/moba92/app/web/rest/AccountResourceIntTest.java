...
import net.moba92.app.MobaApp;
import net.moba92.app.domain.Authority;
import net.moba92.app.domain.User;
import net.moba92.app.repository.AuthorityRepository;
import net.moba92.app.repository.UserRepository;
import net.moba92.app.security.AuthoritiesConstants;
import net.moba92.app.service.MailService;
import net.moba92.app.service.UserService;
import net.moba92.app.web.rest.dto.ManagedUserDTO;
import net.moba92.app.web.rest.dto.UserDTO;
...
@SpringApplicationConfiguration(classes = MobaApp.class)
@WebAppConfiguration
@IntegrationTest
